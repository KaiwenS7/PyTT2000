...
def tt2kToUnix(tt2k: int) -> list[int]:
	...
	unix_sec = 0
	micro_sec = (tt2k%1000000)/1000
	if( i >= nOffsets ):
		# Leap seconds weren't a thing before 1970, use whole unix time
		# tt2k = unix_sec*1000000000 + offsets[nOffsets-1][1]
		unix_sec = (tt2k - offsets[nOffsets-1][1])/1000000000
	
	else:
		# tt2k = (unix_sec - offsets[i][0])*1000000000 + offsets[i][1]
		unix_sec = (tt2k - offsets[i][1])/1000000000 + offsets[i][0]
	

	return [int(unix_sec), int(micro_sec)]
